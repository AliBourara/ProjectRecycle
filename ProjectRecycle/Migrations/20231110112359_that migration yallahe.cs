...
{
    /// <inheritdoc />
    public partial class thatmigrationyallahe : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnalyseDocument = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AvailableDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EndingAvailability = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Missions_AppUsers_ConsultantUserId",
                        column: x => x.ConsultantUserId,
                        principalTable: "AppUsers",
                        principalColumn: "UserId");
                    table.ForeignKey(
                        name: "FK_Missions_Wastes_WasteId",
                        column: x => x.WasteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Missions_ConsultantUserId",
                table: "Missions",
                column: "ConsultantUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Missions_WasteId",
                table: "Missions",
                column: "WasteId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Offers_WasteId",
                table: "Offers",
                column: "WasteId");

            migrationBuilder.CreateIndex(
                name: "IX_Wastes_CompanyId",
                table: "Wastes",
                column: "CompanyId");
        }
